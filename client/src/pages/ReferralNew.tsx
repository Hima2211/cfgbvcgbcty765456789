    ...
    if (navigator.share) {
      try {
        await navigator.share({
          title: 'Join BetChat - Social Betting Platform',
          text: `Join me on BetChat! Use my referral link to get bonus points when you sign up. Let's bet on events and challenge each other!`,
          url: referralUrl,
        });
      } catch (error) {
